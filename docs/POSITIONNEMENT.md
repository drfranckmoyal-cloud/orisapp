...
*Version finale de Franck Moyal, 20 septembre 2026. C'est la version de référence :
toute plaquette, tout site, toute présentation en part.*
...
génération** pour apprendre progressivement votre façon de travailler, votre
vocabulaire et vos habitudes de rédaction. L'objectif : une expérience réellement
personnalisée, des documents toujours plus proches de votre pratique et **des
corrections réduites au minimum**.
...
À la fin de la consultation, **votre documentation est déjà prête, structurée et
...
Ces lignes tiennent parce que le produit les tient. Elles ne doivent jamais dériver
vers ce qu'Oris refuse de faire :

- Oris **n'invente aucun fait clinique**. Chaque phrase s'appuie sur une parole
  réellement prononcée.
- Oris **ne valide rien tout seul**. Le praticien relit et valide ; un document non
  validé porte la mention « brouillon ».
- Oris **ne pose pas de diagnostic** et ne conseille pas de traitement.
- Ce qu'Oris apprend de vous **change sa façon d'écrire, jamais le contenu clinique**.

Dire « Oris rédige vos comptes rendus » est exact. Dire « Oris comprend vos patients »
ne l'est pas.

### Ce que « adaptatif » veut dire, précisément

Le texte de présentation parle de **modèles adaptatifs**. Il faut savoir ce que cela
recouvre, pour que personne en aval n'en fasse une promesse que le produit ne tient
pas :

- Oris retient **votre vocabulaire** (dictionnaire personnel), **vos mots préférés**
  (« avulsion » plutôt qu'« extraction »), **vos habitudes de longueur**. Ces
  éléments sont transmis à chaque traitement et changent ce qui est entendu et la
