...
THEMES: dict[str, dict[str, ConceptLabel]] = {
    ...
    "Examen clinique — usures et esthétique": {
        ...
        "enamel": c("émail", "statement"),
        "dentin": c("dentine", "statement"),
        "tooth_color": c("couleur", "statement"),
        "microdontia": c("microdontie"),
        "tooth_size_discrepancy": c("disharmonie dento-dentaire (DDD)"),
        "bewe_score": c("score BEWE (usure érosive)", "statement"),
        "vertical_dimension": c("dimension verticale d’occlusion (DVO)", "statement"),
    },
    "Examen clinique — parodonte, muqueuses, occlusion": {
        ...
        "angle_class": c("classe d’Angle", "statement"),
        "skeletal_class": c("classe squelettique", "statement"),
    },
    ...
    "Options thérapeutiques et décisions": {
        ...
        "referral": c("adressage à un confrère ou une consœur", "show"),
        ...
        "composite_bonding": c("composite bonding"),
        "ambulatory_whitening": c("éclaircissement ambulatoire"),
        "whitening_tray": c("gouttière d’éclaircissement"),
        "treatment_proposal": c("proposition de traitement", "value_only"),
        "single_session": c("séance unique"),
        "colleague": c("confrère ou consœur", "show"),
        "treatment_failure": c("échec du traitement", "show"),
    },
    "Projet esthétique": {
        "mock_up": c("mock-up"),
        "wax_up": c("wax-up"),
        ...
        "aesthetic_simulation": c("simulation esthétique"),
        "smile_design_software": c("logiciel de projet esthétique", "show"),
        "vertical_dimension_increase": c("augmentation de la dimension verticale", "statement"),
    },
    "Actes — restaurations directes": {
        ...
        "injected_composite": c("composite injecté"),
        "layered_composite": c("composite stratifié"),
        "light_curing": c("polymérisation"),
        "polishing": c("polissage"),
        "rework": c("reprise d’un travail existant", "show"),
    },
    ...
    "Suite et contrôle": {
        ...
        "post_treatment_check": c("contrôle après traitement"),
        "treatment_session": c("séance", "statement"),
    },
    "Matériaux, produits et instruments": {
        "resin": c("résine", "show"),
        "composite_shade": c("teinte du composite", "show"),
        "ceramic": c("céramique", "show"),
        "zirconia": c("zircone", "show"),
        "layered_zirconia": c("zircone stratifiée"),
        "pmma_bar": c("barrette en PMMA"),
        "carbamide_peroxide": c("peroxyde de carbamide", "show"),
        "whitening_product": c("produit d’éclaircissement", "show"),
        "product_used": c("produit utilisé", "show"),
        "staining_agent": c("colorant", "show"),
        "glycerin_gel": c("gel de glycérine"),
        "bonding_system": c("système de collage", "show"),
        "polishing_disc": c("disque de polissage"),
        "spatula": c("spatule"),
    },
}
